...
type TableProps<TData> = {
  table: Table<TData>,
  SubComponent: (props: { row: Row<TData> }) => JSX.Element,
}
...
export class TableSubComponents {
   ...
   * @constructor
   */
  Table({ table, SubComponent }: TableProps<Person>): JSX.Element {
    return (
      <div>
        <table>
          <thead>
  ...
  render() {
    ...
    return (
      <Host>
        ...
        <this.Table table={this.table} SubComponent={this.SubComponent} />
      </Host>
    );
  }
